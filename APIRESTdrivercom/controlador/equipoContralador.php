...
class equipoContralador {
    ...
    function agregarEquipo($nserie, $nombre, $marca, $categ, $estado, $ubi, $fingre, $ingresopor) {
        $uControl = $this->usucontrol->agregarEquipo($nserie, $nombre, $marca, $categ, $estado, $ubi, $fingre, $ingresopor); // Llama al método del modelo
        return $this->mostrarResultado($uControl); // Devuelve el resultado formateado
    }

    // Método para actualizar un usuario existente
    function actualizarEquipo($id, $nserie, $nombre, $marca, $categ, $estado, $ubi, $fingre, $ingresopor) {
        $uControl = $this->usucontrol->actualizarEquipo($id, $nserie, $nombre, $marca, $categ, $estado, $ubi, $fingre, $ingresopor); // Llama al método del modelo
        return $this->mostrarResultado($uControl); // Devuelve el resultado formateado
    }
