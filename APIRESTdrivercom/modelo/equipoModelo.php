...
class equipoModelo
{
    ...
    function agregarEquipo($nserie, $nombre, $marca, $categ, $estado, $ubi, $fingre, $ingresopor)
    {
        // Preparar la consulta SQL para insertar un nuevo usuario
        $sentencia = $this->conn->prepare("INSERT INTO " . $this->tabla . " 
        (Numero_Serie, Nombre_Equipo, Marca, Categoria, Estado, Ubicacion, Fecha_Ingreso, Ingresado_Por, Fecha_Ultimo_Mantenimiento) 
        VALUES (:nserie, :nequipo, :marca, :uategoria, :ustado, :ubicacion, :fingre, :ingrePor, :fmante)");
        ...
        $sentencia->bindParam(':ingrePor', $ingresopor, PDO::PARAM_STR);
    ...
    function actualizarEquipo($id, $nserie, $nombre, $marca, $categ, $estado, $ubi, $fingre, $ingresopor)
    {
        ...
        Categoria = :uategoria,  Estado = :ustado,  Ubicacion = :ubicacion,  Fecha_Ingreso = :fingre,  Ingresado_Por = :ingrePor  
        WHERE ID_Equipo = :id");
