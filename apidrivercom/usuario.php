...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'PUT':
        ...
        if (
            ...
            isset($putData['edit-pass']) &&
            // isset($putData['edit-fmodi']) &&
            ...
            // Asignar los valores a variables
            $id_usuario = $putData['edit-id'];
            $nombre = $putData['edit-nombre'];
            $email = $putData['edit-email'];
            $pass = $putData['edit-pass'];
            $fmodi = date("d-m-Y H:i:s"); // Fecha de creación actual
            // $estado = $putData['edit-fmodi'];
