...
if (isset($data['error'])) {
    ...
    foreach ($data['data'] as $item) {
        ...
        echo '<td>
                ...
                <a href="eliminaEquipo.php?id=' . $id . '" class="button-container" onclick="return confirm(\'¿Estás seguro de que deseas eliminar este registro?\');"><img src="../img/papelera.png"></a>
              </td>';
        echo '</tr>';
    }
}
